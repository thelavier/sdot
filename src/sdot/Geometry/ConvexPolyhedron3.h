...
public:
    ...
    template<class Grid> void           for_each_boundary_measure ( const SpaceFunctions::Constant<TF>     &sf, const FunctionEnum::CompressibleFunc<TF> &r, const Grid &grid, const std::function<void( TF area, CI id )> &f, TF weight = 0 ) const;
    template<class Grid> void           for_each_boundary_measure ( const SpaceFunctions::Constant<TF>     &sf, const FunctionEnum::ExpWmR2db<TF>        &r, const Grid &grid, const std::function<void( TF area, CI id )> &f, TF weight = 0 ) const;
    template<class Grid> void           for_each_boundary_measure ( const SpaceFunctions::Constant<TF>     &sf, const FunctionEnum::Arfd                 &r, const Grid &grid, const std::function<void( TF area, CI id )> &f, TF weight = 0 ) const { TODO; }
    template<class Grid> void           for_each_boundary_measure ( const SpaceFunctions::Constant<TF>     &sf, const FunctionEnum::WmR2                 &r, const Grid &grid, const std::function<void( TF area, CI id )> &f, TF weight = 0 ) const;
    template<class Grid> void           for_each_boundary_measure ( const SpaceFunctions::Constant<TF>     &sf, const FunctionEnum::Unit                 &r, const Grid &grid, const std::function<void( TF area, CI id )> &f, TF weight = 0 ) const;
    template<class Grid> void           for_each_boundary_measure ( const SpaceFunctions::Constant<TF>     &sf, const FunctionEnum::R2                   &r, const Grid &grid, const std::function<void( TF area, CI id )> &f, TF weight = 0 ) const;

    template<class F, class Grid> void  for_each_boundary_item    ( const SpaceFunctions::Constant<TF>     &sf, const FunctionEnum::CompressibleFunc<TF> &rf, const Grid &grid, const F &f, TF weight = 0 ) const;
    template<class F, class Grid> void  for_each_boundary_item    ( const SpaceFunctions::Constant<TF>     &sf, const FunctionEnum::ExpWmR2db<TF>        &rf, const Grid &grid, const F &f, TF weight = 0 ) const;
    template<class F, class Grid> void  for_each_boundary_item    ( const SpaceFunctions::Constant<TF>     &sf, const FunctionEnum::Arfd                 &rf, const Grid &grid, const F &f, TF weight = 0 ) const { TODO; }
    template<class F, class Grid> void  for_each_boundary_item    ( const SpaceFunctions::Constant<TF>     &sf, const FunctionEnum::WmR2                 &rf, const Grid &grid, const F &f, TF weight = 0 ) const;
    template<class F, class Grid> void  for_each_boundary_item    ( const SpaceFunctions::Constant<TF>     &sf, const FunctionEnum::Unit                 &rf, const Grid &grid, const F &f, TF weight = 0 ) const;
    template<class F, class Grid> void  for_each_boundary_item    ( const SpaceFunctions::Constant<TF>     &sf, const FunctionEnum::R2                   &rf, const Grid &grid, const F &f, TF weight = 0 ) const;
