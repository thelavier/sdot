...
public:
    ...
    // traversal
    template<class S,class R,class Grid> void for_each_boundary_measure ( const S &sf, const R &rf, const Grid &grid, const std::size_t nb_diracs, const Pt* positions, const std::function<void( TF boundary_measure, CI id )> &f, TF weight = 0 ) const;

    template<class Grid> void      for_each_boundary_item    ( const SpaceFunctions::Polynomial<TF,6> &sf, const FunctionEnum::CompressibleFunc<TF> &f, const Grid &grid, const std::size_t nb_diracs, const Pt* positions, const std::function<void( const BoundaryItem &boundary_item )> &cb, TF weight = 0 ) const;
    template<class Grid> void      for_each_boundary_item    ( const SpaceFunctions::Polynomial<TF,6> &sf, const FunctionEnum::ExpWmR2db<TF>        &f, const Grid &grid, const std::size_t nb_diracs, const Pt* positions, const std::function<void( const BoundaryItem &boundary_item )> &cb, TF weight = 0 ) const;
    template<class Grid> void      for_each_boundary_item    ( const SpaceFunctions::Polynomial<TF,6> &sf, const FunctionEnum::Arfd                 &f, const Grid &grid, const std::size_t nb_diracs, const Pt* positions, const std::function<void( const BoundaryItem &boundary_item )> &cb, TF weight = 0 ) const;
    template<class Grid> void      for_each_boundary_item    ( const SpaceFunctions::Polynomial<TF,6> &sf, const FunctionEnum::WmR2                 &f, const Grid &grid, const std::size_t nb_diracs, const Pt* positions, const std::function<void( const BoundaryItem &boundary_item )> &cb, TF weight = 0 ) const;
    template<class Grid> void      for_each_boundary_item    ( const SpaceFunctions::Polynomial<TF,6> &sf, const FunctionEnum::Unit                 &f, const Grid &grid, const std::size_t nb_diracs, const Pt* positions, const std::function<void( const BoundaryItem &boundary_item )> &cb, TF weight = 0 ) const;
    template<class Grid> void      for_each_boundary_item    ( const SpaceFunctions::Polynomial<TF,6> &sf, const FunctionEnum::R2                   &f, const Grid &grid, const std::size_t nb_diracs, const Pt* positions, const std::function<void( const BoundaryItem &boundary_item )> &cb, TF weight = 0 ) const;
       
    template<class Grid> void      for_each_boundary_item    ( const SpaceFunctions::Constant<TF>     &sf, const FunctionEnum::CompressibleFunc<TF> &f, const Grid &grid, const std::size_t nb_diracs, const Pt* positions, const std::function<void( const BoundaryItem &boundary_item )> &cb, TF weight = 0 ) const;
    template<class Grid> void      for_each_boundary_item    ( const SpaceFunctions::Constant<TF>     &sf, const FunctionEnum::ExpWmR2db<TF>        &f, const Grid &grid, const std::size_t nb_diracs, const Pt* positions, const std::function<void( const BoundaryItem &boundary_item )> &cb, TF weight = 0 ) const;
    template<class Grid> void      for_each_boundary_item    ( const SpaceFunctions::Constant<TF>     &sf, const FunctionEnum::Arfd                 &f, const Grid &grid, const std::size_t nb_diracs, const Pt* positions, const std::function<void( const BoundaryItem &boundary_item )> &cb, TF weight = 0 ) const;
    template<class Grid> void      for_each_boundary_item    ( const SpaceFunctions::Constant<TF>     &sf, const FunctionEnum::WmR2                 &f, const Grid &grid, const std::size_t nb_diracs, const Pt* positions, const std::function<void( const BoundaryItem &boundary_item )> &cb, TF weight = 0 ) const;
    template<class Grid> void      for_each_boundary_item    ( const SpaceFunctions::Constant<TF>     &sf, const FunctionEnum::Unit                 &f, const Grid &grid, const std::size_t nb_diracs, const Pt* positions, const std::function<void( const BoundaryItem &boundary_item )> &cb, TF weight = 0 ) const;
    template<class Grid> void      for_each_boundary_item    ( const SpaceFunctions::Constant<TF>     &sf, const FunctionEnum::R2                   &f, const Grid &grid, const std::size_t nb_diracs, const Pt* positions, const std::function<void( const BoundaryItem &boundary_item )> &cb, TF weight = 0 ) const;
